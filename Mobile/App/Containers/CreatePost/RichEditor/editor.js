        ...
        var Actions = {
            ...
            content: {
                ...
                setContentStyle: function(styles) {
                    ...
                    var fontSize = styles.fontSize, textAlign = styles.textAlign;
                    ...
                    if (fontSize && fontSize !== editor.content.style.fontSize) editor.content.style.fontSize = fontSize + "px";
                    if (textAlign && textAlign !== editor.content.style.textAlign) editor.content.style.textAlign = textAlign;
